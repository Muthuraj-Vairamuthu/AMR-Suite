...
import resistanceimage from "../assets/image2.png";
const ResistanceAnalysisPage = () => {
    ...
    <div className={styles.analysisPage}>
      ...
      <main className={styles.mainContent}>
        ...
        <div className={styles.rightSection}>
          <img src={resistanceimage} alt="Placeholder" className={styles.chartImage} />
        </div>
      </main>
    </div>
  );
...
export default ResistanceAnalysisPage;
